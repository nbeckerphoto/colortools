...
- [*Bruce Lindbloom: RGB/XYZ Matrices*](http://www.brucelindbloom.com/index.html?Eqn_RGB_XYZ_Matrix.html). Reference for the sRGB/XYZ/CIE L\*a\*b\* conversion matrices and formulas used to build the `lab` color space option in ColorTools.
