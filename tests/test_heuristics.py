...
@pytest.mark.parametrize(
    "test_hue_number, expected_n", [(1, 1), (51, 2), (80, 3), (160, 5), (239, 7), (240, 8), (256, 8)]
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (8, True, [1] * 4, 0.2, 1),  # max_hue_count = 5, hue_count_threshold = 1
        ...
        (8, True, [1, 1, 1, 1, 33, 65], 0.4, 1),  # max_hue_count = 5, hue_count_threshold = 2
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (8, True, [1] * 4, 0.1, 1),  # pixel_count = 12, threhold_hue_count = 2.4
        ...
        (8, True, [1, 1, 1, 1, 33, 33, 65], 0.2, 1),  # pixel_count = 15, hue_count_threshold = 2.25
        ...
        (8, True, [1, 1, 1, 1, 33, 33, 65, 65], 0.2, 1),  # pixel_count = 16, hue_count_threshold = 3.2
