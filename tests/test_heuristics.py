...
from colortools.config import DEFAULT_N_COLORS_MIN
...
@pytest.mark.parametrize(
    ...
    [
        (1, False, DEFAULT_N_COLORS_MIN),
        (32, False, DEFAULT_N_COLORS_MIN),
        (64, False, 2),
        (65, False, 3),
        (160, False, 5),
        (242, False, 8),
        (256, False, 8),
        (1, True, DEFAULT_N_COLORS_MIN),
        (2, True, 2),
        (3, True, 3),
        (5, True, 5),
        (8, True, 8),
...
@pytest.mark.parametrize(
    ...
    [
        (1, False, [], 0, DEFAULT_N_COLORS_MIN),
        (32, False, [], 0, DEFAULT_N_COLORS_MIN),
        (64, False, [], 0, 2),
        (65, False, [], 0, 3),
        (160, False, [], 0, 5),
        (242, False, [], 0, 8),
        ...
        (8, True, [1] * 4, 0.2, DEFAULT_N_COLORS_MIN),  # max_hue_count = 5, hue_count_threshold = 1
        ...
        (8, True, [1, 1, 1, 1, 33, 65], 0.4, DEFAULT_N_COLORS_MIN),  # max_hue_count = 5, hue_count_threshold = 2
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (8, True, [1] * 4, 0.1, DEFAULT_N_COLORS_MIN),  # pixel_count = 12, threhold_hue_count = 2.4
        ...
        (8, True, [1, 1, 1, 1, 33, 33, 65], 0.2, DEFAULT_N_COLORS_MIN),  # pixel_count = 15, hue_count_threshold = 2.25
        ...
        ),  # pixel_count = 16, hue_count_threshold = 3.2
